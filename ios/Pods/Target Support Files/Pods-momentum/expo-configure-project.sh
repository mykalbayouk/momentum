...
with_node \
  ...
  --target "/Users/michaelbayouk/momentum/ios/Pods/Target Support Files/Pods-momentum/ExpoModulesProvider.swift" \
  --entitlement "/Users/michaelbayouk/momentum/ios/momentum/momentum.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-apple-authentication" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
